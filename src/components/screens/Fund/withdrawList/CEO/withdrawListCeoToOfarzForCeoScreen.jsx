...
import { listWithdrawCeoToAgent, listWithdrawCeoToOfarz } from '../../../../../actions/Fund/withdrawActions';
...
const WithdrawListCeoToOfarzForCeoScreen = (props) => {
    ...
    useEffect(() => {
        dispatch(listWithdrawCeoToOfarz(userInfo.item1.phoneNumber))
        return () => {
            //
        };
    }, []);
...
export default WithdrawListCeoToOfarzForCeoScreen;
