...
const WithdrawListKarrotToOfarzAdminAndModeratorScreen = (props) => {

    const [karrotPhoneNumber, setKarrotPhoneNumber] = useState('');

    const withdraw = useSelector((state) => state.withdrawListKarrotToOfarz)
    ...
    const submitHandler = () => {
        ...
        dispatch(listWithdrawKarrotToOfarz(karrotPhoneNumber))
    }
...
export default WithdrawListKarrotToOfarzAdminAndModeratorScreen;
