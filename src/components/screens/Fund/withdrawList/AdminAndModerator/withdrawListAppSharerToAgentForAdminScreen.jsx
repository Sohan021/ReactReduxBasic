...
import { listWithdrawAppSharer, listWithdrawAppSharerToAgent } from '../../../../../actions/Fund/withdrawActions';
...
const WithdrawListAppSharerToAgentForAdminAndModeratorScreen = (props) => {
    ...
    const withdrawAppSharer = useSelector((state) => state.withdrawListAppSharerToAgent)
    ...
    const submitHandler = () => {
        ...
        dispatch(listWithdrawAppSharerToAgent(appSharerPhoneNumber))
    }
            ...
            <div className="row">
                ...
                <div className="col-8">
                    <Card style={{ width: "876px", height: "40px", justifyContent: "center", alignItems: "center", color: "#fff", borderColor: "#5cb85c", background: "#000" }}>
                        App Sharer To Agent Cash Out List
                    </Card>
