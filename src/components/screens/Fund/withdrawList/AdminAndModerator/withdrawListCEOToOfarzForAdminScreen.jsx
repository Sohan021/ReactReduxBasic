...
import { listWithdrawAppSharer, listWithdrawAppSharerToAgent, listWithdrawCeoToAgent, listWithdrawCeoToOfarz } from '../../../../../actions/Fund/withdrawActions';
...
const WithdrawListCeoToOfarzForAdminAndModeratorScreen = (props) => {

    const [ceoPhoneNumber, setCeoPhoneNumber] = useState('');

    const withdraw = useSelector((state) => state.withdrawListCeoToOfarz)
    ...
    const submitHandler = () => {
        ...
        dispatch(listWithdrawCeoToOfarz(ceoPhoneNumber))
    }
...
export default WithdrawListCeoToOfarzForAdminAndModeratorScreen;
