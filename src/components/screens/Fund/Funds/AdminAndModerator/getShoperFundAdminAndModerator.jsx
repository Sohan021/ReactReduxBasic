...
const FundShopperForAdminScreen = (props) => {

    const [shoperPhoneNumber, setShoperPhoneNumber] = useState('');
    ...
    const submitHandler = () => {
        ...
        dispatch(fundShoper(shoperPhoneNumber))
    }
                                            ...
                                            <div className="col col-lg-6">
                                                <FormGroup>
                                                    ...
                                                    <Input type="text"
                                                        name="name"
                                                        id="name"
                                                        placeholder="shoperPhoneNumber"
                                                        size="lg"
                                                        value={shoperPhoneNumber}
                                                        onChange={(e) => setShoperPhoneNumber(e.target.value)}
                                                    />
                                                </FormGroup>
                                            </div>
...
export default FundShopperForAdminScreen;
