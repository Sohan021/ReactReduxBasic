...
import { listPaymentsBackShoppingOfferShoper, listPaymentsShoper, listPaymentsTableCashOfferShoper } from '../../../../../actions/Fund/paymentActions';
...
const PaymentListAllForShopperScreen = (props) => {
    ...
    useEffect(() => {
        dispatch(listPaymentsShoper(userInfo.item1.phoneNumber))
        return () => {
            //
        };
    }, []);
...
export default PaymentListAllForShopperScreen;
