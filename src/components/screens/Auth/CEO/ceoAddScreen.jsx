...
import { ceoRegister } from '../../../../actions/Auth/ceoActions';


function CeoRegistrationScreen(props) {
    ...
    const Register = useSelector(state => state.ceoAdd);
...
export default CeoRegistrationScreen;
