...
import { moderatorAdd } from '../../../../actions/Auth/moderatorActions';


function ModeratorAddScreen(props) {
    ...
    const Register = useSelector(state => state.moderatorAdd);
    const { loading, moderatorInfo, error } = Register;
    ...
    const submitHandler = (e) => {
        ...
        dispatch(moderatorAdd(firstname, lastname, mobilenumber, nid_number, postalcode, profilePhoto, password, confirmPassword));
    ...
    const uploadFileHandler = (e) => {
        ...
        setUploading(true);
        axios
            .post('/api/moderator/savephoto', bodyFormData, {
                headers: {
...
export default ModeratorAddScreen;
